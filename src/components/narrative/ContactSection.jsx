 ...
 * - 'home': full treatment with water background — used on the home page.
 * - 'compact': content-height CTA with subtle water background — shared on inner pages.
 */
  ...
  return (
    ...
    >
      <div ref={waterWrapRef} className="contact-water-wrap" aria-hidden="true">
        <WaterBackground strength={isCompact ? 0.72 : 0.36} />
      </div>
      <div className="wrap">
